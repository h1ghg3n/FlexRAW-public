...
ApplicationContext::ApplicationContext()
    : m_previewOrchestrator(std::make_unique<core::orchestration::PreviewOrchestrator>(
      ...
      m_catalogEditorFacade(std::make_unique<ui::facade::CatalogEditorFacade>(m_managedCatalogSession->orchestrator(),
                                                                              *m_editorOrchestrator)),
      m_mainWindow(std::make_unique<ui::mainwindow::MainWindow>(*m_catalogEditorFacade,
                                                                m_managedCatalogSession->orchestrator(),
                                                                *m_exportOrchestrator))
{}
